  ...
  function handleChange(e) {
    ...
    if (name === 'password' && !validatePassword(value)) {
      setErrors((prevErrors) => ({
        ...prevErrors,
        password: 'Password must contain symbols, lowercase and uppercase letters, and numbers',
      }));
      ...
      setErrors((prevErrors) => ({
        ...prevErrors,
        contactNumber: 'Phone number must be exactly 11 digits',
      }));
      setFormData((prevData) => ({
        ...prevData,
        contactNumber: '',
  ...
  return (
    <form onSubmit={handleSubmit} className="signUpForm">
      ...
      <input
        ...
        onChange={handleChange}
      />
      {errors.contactNumber && <p style={{ color: 'red', fontSize: "1rem" }}>{errors.contactNumber}</p>}
